...
export default function AddOrderSimple() {
  ...
  const addItem = () => {
    setItems([
      ...items,
      { id: Date.now().toString(), product: "", quantity: 1, price: 0 }
    ]);
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => navigate("/dashboard/orders/list"), 1500);
      } else {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <Input value={orderNo} readOnly className="font-mono text-sm" />
          </CardContent>
        </Card>
