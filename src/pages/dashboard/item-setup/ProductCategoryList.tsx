...
const ProductCategoryList = () => {
  ...
  const { productCategories, updateProductCategory, deleteProductCategory } = useStore();
  ...
  const handleSaveEdit = () => {
    if (editingCategory) {
      updateProductCategory(editingCategory.id, editForm);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => navigate("/dashboard/item-setup/add-product-category")} className="gap-2">
